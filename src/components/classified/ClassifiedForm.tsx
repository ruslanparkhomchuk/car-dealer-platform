...
import { ClassifiedFormFields } from "./ClassifiedFormFields";
...
export function ClassifiedForm({ classified }: ClassifiedFormProps) {
	...
	function classifiedFormSubmit(data: UpdateClassifiedType): void {
