					...
					<div className="p-4 flex flex-col space-y-3">
						<div>
							<Link
								...
								className="text-sm md:text-base lg:text-lg font-semibold text-slate-800 line-clamp-1 transition-colors hover:text-primary"
							>
								{classified.title}
							</Link>
						...
						<div className="mt-4 flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:gap-x-2 w-full">
							<Button
								className="flex-1 transition-colors hover:bg-primary hover:text-white! py-2 lg:py-2.5 h-full text-xs md:text-sm xl:text-base"
								asChild
								variant="outline"
								size="sm"
							>
