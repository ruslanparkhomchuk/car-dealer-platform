...
import { ClassifiedAISchema } from "@/app/schemas/classifiedAI.schema";
import {
	SingleImageSchema,
...
import type { StreamableSkeletonProps } from "./StreamableSkeleton";
...
export function CreateClassifiedDialog() {
	...
	function onImageSubmit(data: SingleImageType): void {
	...
	function onCreateSubmit(data: StreamableSkeletonProps): void {
